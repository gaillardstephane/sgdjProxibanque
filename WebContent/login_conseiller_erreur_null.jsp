...
<body>
	...
	<section class="container-fluid about">
		<div class="container">
			<div class="row">
				<legend class="text-center"> Erreur Login </legend>
		      	<div class="col-md-10 col-md-offset-3">
			        <div class="well well-sm">
			        	Bonjour, vous n'avez pas rentré de valeur dans le champ login ou password.<br/>
			          	Veuillez recommencer.
			        </div>
		        <div class="col-md-12 text-right">
			        <form class="form-horizontal" method="post" action="proxi_v3_accueil_conseiller.html">
